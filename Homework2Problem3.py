...
# Problem 3 Part A                                                                                      # Part B
print("Enter .csv file path would you like to read: ")                                                  # c
filepath = stdin.readline().strip()                                                                     # c
I = []                                                                                                  # c
with open(filepath) as csvfile:                                                                         # c
    data = csv.reader(csvfile)                                                                          # c
    print("Imputed data: ")                                                                             # c
    for line in data:                                                                                   # c
        l = map(float, line)                                                                            # c
        print(l)                                                                                        # c
        I.append(l)                                                                                     # c
...
# Total computational cost: (1/2)n^2 + 25n + 4log(n) + d + c
